...
mixin _$LoadingMobx on LoadingMobxBase, Store {
  late final _$loadingAtom =
      Atom(name: 'LoadingMobxBase.loading', context: context);
  ...
  late final _$LoadingMobxBaseActionController =
      ActionController(name: 'LoadingMobxBase', context: context);

  @override
  dynamic setLoading(bool value) {
    final _$actionInfo = _$LoadingMobxBaseActionController.startAction(
        name: 'LoadingMobxBase.setLoading');
    try {
